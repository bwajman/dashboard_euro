...
def fig8(df):
    ...
    fig8.update_layout(
        ...
        xaxis=dict(title='Matches', titlefont_size=16, ticktfont_size=14),
        yaxis=dict(title='Goals', titlefont_size=16, ticktfont_size=14),
...
def chart_passes(df):
    ...
    fig4.update_layout(
        title='Goals and matches',
        xaxis=dict(title='Pass Accuracy (avg)', titlefont_size=16, ticktfont_size=14),
        yaxis=dict(title='Total passes (avg)', titlefont_size=16, ticktfont_size=14),
        legend=dict(x=0, y=1.0, bgcolor='rgba(255, 255, 255, 0)', bordercolor='rgba(255, 255, 255, 0)'),
        bargap=0.2,
        bargroupgap=0.1
    )
...
def chart_shots(df):
    ...
    fig5.update_layout(
        ...
        xaxis=dict(title=option, titlefont_size=16, ticktfont_size=14),
        yaxis=dict(title=option1, titlefont_size=16, ticktfont_size=14),
        legend=dict(x=0, y=1.0, bgcolor='rgba(255, 255, 255, 0)', bordercolor='rgba(255, 255, 255, 0)'),
        bargap=0.2,
        bargroupgap=0.1
    )
...
def chart_fouls(df):
    ...
    fig6.update_layout(
        ...
        xaxis=dict(title='Fouls', titlefont_size=16, ticktfont_size=14),
        yaxis=dict(title='Yellow cards', titlefont_size=16, ticktfont_size=14),
        legend=dict(x=0, y=1.0, bgcolor='rgba(255, 255, 255, 0)', bordercolor='rgba(255, 255, 255, 0)'),
        bargap=0.2,
        bargroupgap=0.1
    )
